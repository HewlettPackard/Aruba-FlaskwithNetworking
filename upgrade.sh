...
echo "########## CommPass release 2.1 upgrade ##########"
...
echo "Upgrading to CommPass version 2.3 on $var2"
fi
...
service CommPass start

echo " ######### CommPass upgrade to version 2.3 completed ##########"
